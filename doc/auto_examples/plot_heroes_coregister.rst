...
.. _sphx_glr_auto_examples_plot_heroes_coregister.py:
...
../examples/plot_heroes_coregister.py is not compiling:
...
**Download Python source code:** :download:`plot_heroes_coregister.py <plot_heroes_coregister.py>`
